/**
 * Util Task 49 — buat/hapus akun uji UjiBrowser49 (password: uji49).
 * Pemakaian: bun .zscripts/t49-fixture.ts create | cleanup
...
if (process.argv[2] === "create") {
  ...
  out("usage: bun .zscripts/t49-fixture.ts create|cleanup");
}
