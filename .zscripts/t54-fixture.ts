/**
 * Util Task 54 — buat/hapus akun uji UjiBrowser54 (password: uji54).
 * Pemakaian: bun .zscripts/t54-fixture.ts create | cleanup
...
if (process.argv[2] === "create") {
  ...
  if (existing) {
    ...
    const ts = Date.now();
    const hash = Bun.password.hashSync("uji54", { algorithm: "bcrypt", cost: 10 });
    db.run(
  ...
  out("usage: bun .zscripts/t54-fixture.ts create|cleanup");
}
