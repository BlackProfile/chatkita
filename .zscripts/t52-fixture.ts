/**
 * Util Task 52 — buat/hapus akun uji UjiBrowser52 (password: uji52).
 * Pemakaian: bun .zscripts/t52-fixture.ts create | cleanup
...
if (process.argv[2] === "create") {
  ...
  if (existing) {
    ...
    const ts = Date.now();
    const hash = Bun.password.hashSync("uji52", { algorithm: "bcrypt", cost: 10 });
    db.run(
  ...
  out("usage: bun .zscripts/t52-fixture.ts create|cleanup");
}
