/**
 * Util Task 51 — buat/hapus akun uji UjiBrowser51 (password: uji51).
 * Pemakaian: bun .zscripts/t51-fixture.ts create | cleanup
...
if (process.argv[2] === "create") {
  ...
  if (existing) {
    ...
    const ts = Date.now();
    const hash = Bun.password.hashSync("uji51", { algorithm: "bcrypt", cost: 10 });
    db.run(
  ...
  out("usage: bun .zscripts/t51-fixture.ts create|cleanup");
}
