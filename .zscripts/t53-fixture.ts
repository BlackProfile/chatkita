/**
 * Util Task 53 — buat/hapus akun uji UjiBrowser53 (password: uji53).
 * Pemakaian: bun .zscripts/t53-fixture.ts create | cleanup
...
if (process.argv[2] === "create") {
  ...
  if (existing) {
    ...
    const ts = Date.now();
    const hash = Bun.password.hashSync("uji53", { algorithm: "bcrypt", cost: 10 });
    db.run(
  ...
  out("usage: bun .zscripts/t53-fixture.ts create|cleanup");
}
