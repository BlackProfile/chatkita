/**
 * Util Task 47 — buat/hapus akun uji UjiBrowser47 (password: uji47).
 * Pemakaian: bun .zscripts/t47-fixture.ts create | cleanup
...
if (process.argv[2] === "create") {
  ...
  if (existing) {
    ...
    const ts = Date.now();
    const hash = Bun.password.hashSync("uji47", { algorithm: "bcrypt", cost: 10 });
    db.run(
  ...
  out("usage: bun .zscripts/t47-fixture.ts create|cleanup");
}
