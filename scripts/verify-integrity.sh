...
# ── v52 (Task 68) — AI panel, poll, game, lokasi/kontak, 2FA, widget, backup ──
...
chk_grep "Mini-game (game:play)"              "mini-services/chat-service/index.ts" "game:play"
...
chk_grep "Preview snippet pesan v52"          "mini-services/chat-service/index.ts" "type === 'game') return '🎮 Mini-game'"
...
chk_grep "Kartu game di ChatBubble"           "src/components/chat/ChatBubble.tsx" "type === \"game\" && gameData"
...
chk_grep "Menu game user"                     "src/components/chat/Messenger.tsx" "Main game"
...
chk_grep "Versi service v59"                    "mini-services/chat-service/index.ts" "SERVICE_VERSION = 'v59'"
