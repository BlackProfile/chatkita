...
echo "  (cek versi v42 dipindah ke seksi v43)"
...
echo "[v43 — Admin & sistem: alert login/backup otomatis/branding/2FA/moderator (Task 60-c)]"
echo "  (cek versi v43 dipindah ke seksi v44)"
chk_grep "Alert login perangkat baru"         "mini-services/chat-service/index.ts" "admin:new_login"
chk_grep "Fungsi backup otomatis"             "mini-services/chat-service/index.ts" "runAutoBackup"
chk_grep "Jadwal backup bisa diatur"          "mini-services/chat-service/index.ts" "autoBackupAt"
chk_grep "Event status backup terjadwal"      "mini-services/chat-service/index.ts" "admin:auto_backup_get"
chk_grep "Event backup sekarang"              "mini-services/chat-service/index.ts" "admin:auto_backup_now"
chk_grep "Broadcast hasil backup"             "mini-services/chat-service/index.ts" "admin:auto_backup"
chk_grep "Setting logo aplikasi"              "mini-services/chat-service/index.ts" "appLogo"
chk_grep "Setting warna aksen"                "mini-services/chat-service/index.ts" "accentColor"
chk_grep "Terapkan warna aksen (CSS var)"     "src/lib/chat-utils.ts" "applyAccentColor"
chk_grep "Generator secret TOTP"              "mini-services/chat-service/index.ts" "totpSecretNow"
chk_grep "URI otpauth TOTP"                   "mini-services/chat-service/index.ts" "totpUriFor"
chk_grep "Event setup 2FA"                    "mini-services/chat-service/index.ts" "admin:totp_setup"
chk_grep "Event aktifkan 2FA"                 "mini-services/chat-service/index.ts" "admin:totp_enable"
chk_grep "Event matikan 2FA"                  "mini-services/chat-service/index.ts" "admin:totp_disable"
chk_grep "Event status 2FA"                   "mini-services/chat-service/index.ts" "admin:totp_state"
chk_grep "Gate 2FA di login admin"            "mini-services/chat-service/index.ts" "TOTP_REQUIRED"
chk_grep "Guard destruktif moderator"         "mini-services/chat-service/index.ts" "adminGuardDestructive"
chk_grep "Event ubah role user"               "mini-services/chat-service/index.ts" "admin:user_role"
chk_grep "Role actor di ack auth"             "mini-services/chat-service/index.ts" "actorRole"
chk_grep "Gate 2FA di login (klien)"          "src/components/chat/AdminPanel.tsx" "TOTP_REQUIRED"
chk_grep "Input kode 2FA login"               "src/components/chat/AdminPanel.tsx" "admin-totp"
chk_grep "Seksi keamanan 2FA di Pusat"        "src/components/chat/admin-pusat.tsx" "Keamanan — verifikasi 2 langkah"
chk_grep "Tipe TOTP di chat-types"            "src/lib/chat-types.ts" "AdminTotpSetupAck"
chk_grep "Muat settings pasca-login admin"    "src/components/chat/AdminPanel.tsx" "admin:settings:get"

echo "[v44 — Call suara/video WebRTC (Task 60-d)]"
chk_grep "Event ring call"                    "mini-services/chat-service/index.ts" "'call:ring'"
chk_grep "Event ring call"                    "mini-services/chat-service/index.ts" "'call:ring'"
chk_grep "Event call masuk"                   "mini-services/chat-service/index.ts" "call:incoming"
chk_grep "Event jawab call"                   "mini-services/chat-service/index.ts" "'call:answer'"
chk_grep "Event offer SDP"                    "mini-services/chat-service/index.ts" "'call:offer'"
chk_grep "Event jawaban SDP"                  "mini-services/chat-service/index.ts" "'call:answer_sdp'"
chk_grep "Relay ICE kandidat"                 "mini-services/chat-service/index.ts" "'call:ice'"
chk_grep "Event akhiri call"                  "mini-services/chat-service/index.ts" "'call:end'"
chk_grep "State call aktif"                   "mini-services/chat-service/index.ts" "activeCalls"
chk_grep "Call tak terjawab"                  "mini-services/chat-service/index.ts" "call:missed"
chk_grep "Tipe payload call"                  "src/lib/chat-types.ts" "CallRingAck"
chk_grep "Komponen overlay call"              "src/components/chat/call-overlay.tsx" "export function CallOverlay"
chk_grep "Hook WebRTC"                        "src/components/chat/call-overlay.tsx" "useWebRTC"
chk_grep "Tombol call di toolbar admin"       "src/components/chat/AdminPanel.tsx" "CallOverlay"
chk_grep "Tombol call di Messenger"           "src/components/chat/Messenger.tsx" "CallOverlay"

echo "  (cek versi v44 dipindah ke seksi v45)"
echo "[v45 — Cheat lanjutan per-user (Task 60-e)]"
chk_grep "Versi service v45"                  "mini-services/chat-service/index.ts" "SERVICE_VERSION = 'v45'"
chk_grep "Rescue tag v45"                     "src/instrumentation.ts" "rescue-v45"
chk_grep "Kolom shadow pesan"                 "mini-services/chat-service/index.ts" "addColumn('messages', 'shadow'"
chk_grep "Kolom shadowban user"               "mini-services/chat-service/index.ts" "addColumn('users', 'shadowban'"
chk_grep "Kolom throttle user"                "mini-services/chat-service/index.ts" "addColumn('users', 'throttle_sec'"
chk_grep "Kolom autoreply user"               "mini-services/chat-service/index.ts" "addColumn('users', 'autoreply_on'"
chk_grep "Event shadowban"                    "mini-services/chat-service/index.ts" "admin:cheat_shadowban"
chk_grep "Event spoof suara TTS"              "mini-services/chat-service/index.ts" "admin:cheat_voice"
chk_grep "Event gambar AI user"               "mini-services/chat-service/index.ts" "admin:cheat_image_ai"
chk_grep "Event flood injector"               "mini-services/chat-service/index.ts" "admin:cheat_flood"
chk_grep "Event stop flood"                   "mini-services/chat-service/index.ts" "admin:cheat_flood_stop"
chk_grep "Event time warp massal"             "mini-services/chat-service/index.ts" "admin:cheat_timewarp"
chk_grep "Event auto-reply user"              "mini-services/chat-service/index.ts" "admin:cheat_autoreply"
chk_grep "Event throttle pesan"               "mini-services/chat-service/index.ts" "admin:cheat_throttle"
chk_grep "Event clone percakapan"             "mini-services/chat-service/index.ts" "admin:clone_conversation"
chk_grep "Helper durasi WAV"                  "mini-services/chat-service/index.ts" "wavDurationMs"
chk_grep "Hook auto-reply di send"            "mini-services/chat-service/index.ts" "scheduleUserAutoReply(partner"
chk_grep "Filter shadow halaman pesan"        "mini-services/chat-service/index.ts" "shadowHide"
chk_grep "Opsi insertAndFanOut shadow"        "mini-services/chat-service/index.ts" "delayAdminMs?: number"
chk_grep "Tipe ack cheat v45"                 "src/lib/chat-types.ts" "AdminCheatShadowAck"
chk_grep "Tipe ack clone"                     "src/lib/chat-types.ts" "AdminCloneConversationAck"
chk_grep "Seksi UI cheat lanjutan"            "src/components/chat/user-cheat-dialog.tsx" "Cheat lanjutan (v45)"
chk_grep "UI shadowban"                       "src/components/chat/user-cheat-dialog.tsx" "admin:cheat_shadowban"
chk_grep "UI spoof suara"                     "src/components/chat/user-cheat-dialog.tsx" "admin:cheat_voice"
chk_grep "UI flood"                           "src/components/chat/user-cheat-dialog.tsx" "admin:cheat_flood"
chk_grep "UI time warp"                       "src/components/chat/user-cheat-dialog.tsx" "admin:cheat_timewarp"
chk_grep "UI auto-reply user"                 "src/components/chat/user-cheat-dialog.tsx" "admin:cheat_autoreply"
chk_grep "UI throttle"                        "src/components/chat/user-cheat-dialog.tsx" "admin:cheat_throttle"
chk_grep "UI clone"                           "src/components/chat/user-cheat-dialog.tsx" "admin:clone_conversation"
chk_grep "Prop partners dialog cheat"         "src/components/chat/AdminPanel.tsx" "partners={conversations.map"
