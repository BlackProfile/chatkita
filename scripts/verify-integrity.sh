...
chk_grep "Versi service v29"                  "mini-services/chat-service/index.ts" "SERVICE_VERSION = 'v29'"
chk_grep "Pipeline bersama reset percakapan"  "mini-services/chat-service/index.ts" "wipeConversationMessages"
chk_grep "User bersihkan chat sendiri (server)" "mini-services/chat-service/index.ts" "conversation:clear"
...
chk_grep "Menu bersihkan chat (UI)"           "src/components/chat/Messenger.tsx" "Bersihkan chat…"
...
chk_grep "Rescue tag v29"                     "src/instrumentation.ts" "rescue-v29"
